        ...
        <div className="w-full flex flex-col justify-center">
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="text-base font-semibold text-drexel-yellow hover:text-[#fcd81e] drop-shadow-[0_0px_0.8px_rgba(255,255,255,255.8)]"
            >
              {isSignUp ? 'Already have an account? Sign In' : 'Not a member? Sign Up Here'}
            </button>
          </div>
        </div>
      </div>
